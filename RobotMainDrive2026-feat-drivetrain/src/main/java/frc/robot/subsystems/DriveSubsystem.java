...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() { zeroHeading(); }
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    m_frontLeft.setDesiredState(states[0]); m_frontRight.setDesiredState(states[1]);
    m_backLeft.setDesiredState(states[2]);  m_backRight.setDesiredState(states[3]);
  }
  ...
  public void stopModules() {
    m_frontLeft.stop(); m_frontRight.stop(); m_backLeft.stop(); m_backRight.stop();
  }

  public void setZero() {
    m_frontLeft.setZero(); m_frontRight.setZero(); m_backLeft.setZero(); m_backRight.setZero();
  }
