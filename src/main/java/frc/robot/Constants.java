...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kFrontLeftAbsOffsetRad = 0.0;
    public static final double kFrontRightAbsOffsetRad = 0.0;
    public static final double kBackLeftAbsOffsetRad = 0.0;
    public static final double kBackRightAbsOffsetRad = 0.0;
