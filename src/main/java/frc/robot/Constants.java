...
public final class Constants {
    ...
    public static final class AutoConstants {
        ...
        public static final Pose2d blueAllianceTop = new Pose2d(0 + cornerOffsetX, 8.069 - cornerOffsetY,
                Rotation2d.kZero);// (0,8.069)
        public static final Pose2d blueAllianceBottom = new Pose2d(0 + cornerOffsetX, 0 + cornerOffsetY,
                Rotation2d.kZero);
        public static final Pose2d redAllianceTop = new Pose2d(16.54 - cornerOffsetX, 8.069 - cornerOffsetY,
                Rotation2d.kZero); // (8.069, 16.54)
        public static final Pose2d redAllianceBottom = new Pose2d(16.54 - cornerOffsetX, 0 + cornerOffsetY,
                Rotation2d.kZero); // (16.54, 0)
    }
    ...
    public static final class DriveConstants {
        ...
        public static final Translation2d kFrontLeftLocation = new Translation2d(kWheelBaseMeters / 2.0,
                kTrackWidthMeters / 2.0);
        public static final Translation2d kFrontRightLocation = new Translation2d(kWheelBaseMeters / 2.0,
                -kTrackWidthMeters / 2.0);
        public static final Translation2d kBackLeftLocation = new Translation2d(-kWheelBaseMeters / 2.0,
                kTrackWidthMeters / 2.0);
        public static final Translation2d kBackRightLocation = new Translation2d(-kWheelBaseMeters / 2.0,
                -kTrackWidthMeters / 2.0);
